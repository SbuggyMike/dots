...
(global-unset-key (kbd "C-x C-c")) ; stop accidentally closing emacs (save-buffers-kill-terminal)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-journal evil 0xc 0x0 pdf-tools org-modern emms doom-modeline doom-themes marginalia try company diminish swiper projectile markdown-mode))
