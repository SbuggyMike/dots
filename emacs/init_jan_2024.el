...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ada-ref-man ack ada-mode chatgpt org-journal ace-window org-drill org-capture org-roam zenburn-theme which-key try projectile pdf-tools magit ivy-rich helpful diminish counsel)))
(custom-set-faces
